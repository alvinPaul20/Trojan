    ...
    label.innerHTML = `
            <div class="text-center">
                ...
                <button class="btn btn-success" type="button">
                    <a class="text-light text-decoration-none" href="/shop">Back to Shop</a>
                </button>
            </div>`;
    }
}
...
let totalAmount = () =>{
    ...
    <div class="bill d-flex justify-content-center gap-4 p-3">
        <div id="deleteAll">
            <button onclick="clearCart()" type="button" class="btn btn-danger">Delete All</button>
        </div>
        <div class="checkout">
            <button type="button" class="btn btn-success">
                <a href="/login" class="text-light text-decoration-none">Check-Out</a>
            </button>
        </div>
        <div class="text-center">
            <h2>Total Bill:</h2>
            <h2><i class="fa-solid fa-peso-sign"></i>${amount}</h2>
        </div>
    </div>
`;
    }else{
